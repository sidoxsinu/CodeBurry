        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="glass w-full bg-green-600 hover:bg-green-700 text-green-900 py-3 px-4 rounded-lg font-semibold transition-colors"
                  >
                    Send Message 🚀
                  </button>
                </form>
            ...
            >
              ...
              {/* Community Links */}
              <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl p-6 mt-6 text-green-900 text-center">
