      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Create your account and begin growing your coding garden
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-3 border placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-3 pr-10 border placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 ${
        ...
        >
          ...
          <ul className="text-xs text-green-700 space-y-1">
            <li>• Free access to all programming courses</li>
            <li>• Gamified learning with water drops & virtual garden</li>
